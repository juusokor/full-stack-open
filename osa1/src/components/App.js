  ...
  render() {
    return (
      <div>
        ...
        <NewNumber handleSubmit={this.addName} newNameState={this.state.newName} newNumberState={this.state.newNumber} handleNameChange={this.handleNameChange} handleNumberChange={this.handleNumberChange}/>
